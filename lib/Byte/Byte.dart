...
import 'Bytes_Calculation.dart';

class Bytespage extends StatefulWidget {
  const Bytespage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Expanded(
            child: Image.network(
              'https://images.unsplash.com/photo-1601737487795-dab272f52420?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
